...
window.HELPERS = [
  ...
  },
  {
    ...
    initial: "",
    status: "available",
    statusLabel: "Available now (in Thailand)",
  ...
  },
  {
    ...
    initial: "",
    status: "available",
    statusLabel: "Available from 20 August&nbsp;2026",
    availFrom: "2026-08-20",
    line: "Myanmar &middot; 30 &middot; Elderly care, childcare &amp; cooking",
    summary: "Nearly three years with one Singapore family across two of their households, confirmed against MOM records &mdash; elderly care, four children including one she has had from a baby, and comfortable with dogs.",
    referredBy: "",
    signal: "verified",
    renewals: 1,
    quote: "",
    quoteCite: "",
    nationality: "Myanmar",
    yearsSG: "Nearly 3 years",
    bestFit: "A household needing elderly care, or a family with school-age children and a busy activity week",
    strengths: ["One family, two households", "Elderly care &amp; childcare", "School runs &amp; activities"],
