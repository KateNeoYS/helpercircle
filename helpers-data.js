...
window.HELPERS = [
  ...
  },
  {
    ...
    summary: "Nearly six years with one Singapore family &mdash; her only employer here, supported by employment records we reviewed. She took their younger child at five months and has had both children&nbsp;since. Moving on because she would like one household rather than&nbsp;three.",
    referredBy: "",
    signal: "verified",
    verifiedYears: 5,
    nationality: "Filipino",
    yearsSG: "Since December 2020",
    bestFit: "One family in one home, with young children &mdash; after nearly six years working across&nbsp;three",
    strengths: ["Nearly six years, one family", "A baby from five months old", "Wants a single household next"],
    skills: ["Childcare", "Infant Care", "Cooking", "Housekeeping"],
    age: 33,
    salary: "",
    availability: "transfer",
