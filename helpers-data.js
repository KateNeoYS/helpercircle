...
window.HELPERS = [
  ...
  },
  {
    ...
    status: "available",
    statusLabel: "Available now",
    line: "Filipino &middot; 34 &middot; Cooking, household &amp; children",
    summary: "Recommended by her employer, who confirms her work was never the issue &mdash; she is leaving a fully vegetarian household she could not eat in every&nbsp;day.",
    referredBy: "Referred by her most recent employer, who recommends her&nbsp;directly",
    signal: "referred",
    renewals: 0,
    quote: "",
    quoteCite: "",
    ...
    bestFit: "A family for whom the cooking is the centre of the job, with children or pets in the&nbsp;home",
    strengths: ["Recommended by her employer", "Cooks to a plan and a budget", "Comfortable with dogs"],
    skills: ["Cooking", "Housekeeping", "Childcare", "Pets", "Gardening"],
    age: 34,
    salary: "",
    availability: "now",
  ...
  },
  {
    ...
    strengths: ["Sixteen years, one family", "Everyday Chinese home cooking", "Trusted on her own"],
