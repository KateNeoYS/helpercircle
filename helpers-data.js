...
window.HELPERS = [
  ...
  },
  {
    ...
    status: "available",
    statusLabel: "Available now",
    availFrom: "2026-09-21",
    line: "Filipino &middot; 51 &middot; Babies, toddlers, household &amp;&nbsp;dogs",
    summary: "Warmly recommended in writing by a previous family she cared for over nearly three&nbsp;years &mdash; a gentle, experienced carer of babies and&nbsp;toddlers. She runs a condominium household on her own now, and looks after a large dog&nbsp;daily. Available only because that family no longer need a&nbsp;helper.",
    referredBy: "Recommended in writing by Avesh &amp; Mairead, her employers of nearly three&nbsp;years",
    signal: "referred",
    quote: "\u201cVioleta really stood out in the care she gave our daughter. We trusted her fully to look after her on her&nbsp;own.\u201d",
    quoteCite: "&mdash; Avesh &amp; Mairead, her employers 2023&ndash;2026",
    nationality: "Filipino",
    yearsSG: "Ten-plus years",
    bestFit: "A family with a baby or toddler, or with older independent children &mdash; comfortable with a dog in the&nbsp;house",
    strengths: ["Recommended in writing", "Gentle with babies &amp; toddlers", "Cares for a large dog daily"],
    skills: ["Childcare", "Infant Care", "Cooking", "Housekeeping", "Pets"],
    age: 51,
    salary: "",
    availability: "transfer",
  ...
  },
  {
    ...
    status: "placed",
    matchedSeq: 22,
    statusLabel: "Joined a new family &middot; 26 Sep&nbsp;2026",
  ...
  },
  {
    ...
    initial: "",
    status: "available",
    statusLabel: "Available now &middot; in Batam",
    availFrom: "2026-09-11",
    line: "Indonesian &middot; 40 &middot; Infants, toddlers, cooking &amp; baking",
    summary: "Recommended in writing by a former employer as trustworthy and independent &mdash; a confident cook and baker who has started with children at six and eight months&nbsp;old. She is in Batam now, so hiring her means a new Work Permit rather than a&nbsp;transfer.",
  ...
  },
  {
    ...
    initial: "",
    status: "available",
    statusLabel: "Available third week of October&nbsp;2026",
    availFrom: "2026-10-19",
    line: "Filipino &middot; 47 &middot; Baby and child care, cooking &amp;&nbsp;household",
    summary: "One Singapore family hired her back four separate times between 2016 and&nbsp;2026 &mdash; nearly five years with them&nbsp;altogether. She is caring for a baby now, and can transfer from the third week of&nbsp;October.",
    referredBy: "Recommended by Eugene, who hired her back four separate times over ten&nbsp;years",
    signal: "referred",
    quote: "\u201cI can send her a map and trust her to take the children somewhere new, on her&nbsp;own.\u201d",
    quoteCite: "&mdash; Eugene, the employer who kept asking her&nbsp;back",
    nationality: "Filipino",
    yearsSG: "Since November 2016",
    bestFit: "A family with a child of any age, from a baby upward &mdash; particularly one happy to hand her the job and let her run&nbsp;it",
    strengths: ["Hired back four times", "Babies from nine months", "Works independently"],
  ...
  },
  {
    ...
    name: "Menchie",
    initial: "",
    status: "hidden",                                 // hidden 18 Sep 2026
    statusLabel: "No longer listed",
    availFrom: "2026-09-30",
  ...
  },
  {
    ...
    line: "Filipino &middot; 41 &middot; Chinese home cooking, household &amp; pet&nbsp;care",
    summary: "Recommended by the family she works for now &mdash; a landed house she has largely run on her own while her employer worked long hours, and nearly six years with one family before&nbsp;that.",
    referredBy: "Referred by Esther, her employer since November 2024, happy to be&nbsp;contacted",
    signal: "referred",
    nationality: "Filipino",
    yearsSG: "8 years",
    bestFit: "A household that will tell her plainly what it wants, and then let her get on with&nbsp;it",
    strengths: ["Recommended by her employer", "Nearly six years, one family", "Runs the house independently"],
  ...
  },
  {
    ...
    nationality: "Filipino",
    yearsSG: "11 years",
    bestFit: "A family with a baby coming, a small child, or older ones &mdash; she has done the newborn stage three times and is happy either&nbsp;way",
  ...
  },
  {
    ...
    statusLabel: "Joined a new family &middot; 21 Sep&nbsp;2026",
    availFrom: "2026-09-21",
    line: "Filipino &middot; 38 &middot; Childcare, cooking &amp;&nbsp;household",
    summary: "Ten years with one Singapore family of four children, supported by employment records we reviewed &mdash; she took the youngest from newborn to ten, and helped with the older three, the cooking and the household&nbsp;besides. Available only because her employer&rsquo;s former helper is&nbsp;returning.",
    referredBy: "",
    signal: "verified",
    verifiedYears: 10,
    nationality: "Filipino",
    ...
    bestFit: "Any household with children &mdash; she has done a newborn, a house with four of them, and the cooking and cleaning&nbsp;alongside",
    strengths: ["Ten years, one family", "Four children in one home", "Newborn through to ten"],
    skills: ["Housekeeping", "Cooking", "Childcare", "Infant Care"],
    age: 38,
    salary: "S$900",
    availability: "transfer",
    photo: "images/luisa.jpeg",
    profile: "profile-luisa.html"
  },
  {
    id: "sally",
    name: "Sally",
    initial: "F.",
    status: "available",
    statusLabel: "Available end December&nbsp;2026",
    availFrom: "2026-12-31",
    line: "Filipino &middot; 49 &middot; Baking, cooking &amp;&nbsp;childcare",
    summary: "Recommended in writing by her current employer, who is relocating &mdash; five and a half years with one family before them, and a serious home baker: bread, focaccia, pizza, cinnamon rolls and&nbsp;cakes.",
    referredBy: "Referred by Sebastien H., her current employer, who has written a signed&nbsp;reference",
    signal: "referred",
    quote: "\u201cSally is reliable, trustworthy, and very caring. She was punctual, flexible, and completed every aspect of her job with the highest level of&nbsp;professionalism.\u201d",
    quoteCite: "&mdash; Sebastien H., her current employer",
    nationality: "Filipino",
    yearsSG: "Since 2013",
    bestFit: "A family with children of two and up who would value a real baker in the&nbsp;house",
    strengths: ["Written reference, plus a second referee", "Five and a half years, one family", "Serious home baker"],
  ...
  },
  {
    ...
    initial: "C.",
    status: "available",
    statusLabel: "Available late November / early December&nbsp;2026",
    availFrom: "2026-11-28",
    line: "Filipino &middot; 33 &middot; Childcare, cooking &amp;&nbsp;household",
    summary: "Nearly six years with one Singapore family &mdash; her only employer here, supported by employment records we reviewed. She took their younger child at five months and has had both children&nbsp;since. Moving on because she is sent to the grandparents&rsquo; house every week &mdash; she would like to stay and work in one&nbsp;place.",
    referredBy: "",
    signal: "verified",
    verifiedYears: 5,
    nationality: "Filipino",
    yearsSG: "Since December 2020",
    bestFit: "One family in one home, with young children &mdash; after nearly six years split between&nbsp;two",
    strengths: ["Nearly six years, one family", "A baby from five months old", "Wants to work in one place"],
    skills: ["Childcare", "Infant Care", "Cooking", "Housekeeping"],
    age: 33,
    salary: "",
    availability: "transfer",
  ...
  },
  {
    ...
    initial: "N.",
    status: "available",
    statusLabel: "Available 1 October&nbsp;2026",
    availFrom: "2026-10-01",
    line: "Indonesian &middot; 30 &middot; Household, cooking &amp;&nbsp;marketing",
    summary: "Her employer renewed her for a second two-year term and then wrote her this&nbsp;reference &mdash; she is leaving by her own&nbsp;choice. Three Singapore households in six years, each one completed or&nbsp;renewed. Chinese, Western and Indonesian&nbsp;cooking.",
    referredBy: "Recommended in writing by her current employer, who renewed her&nbsp;contract",
    signal: "referred",
    quote: "&ldquo;She follows instructions well and does not miss the medication&nbsp;timing. Lia can learn&nbsp;fast.&rdquo;",
    quoteCite: "&mdash; her current employer, in a written&nbsp;reference",
    nationality: "Indonesian",
    yearsSG: "Since August 2019",
    bestFit: "A household that wants the house run properly and the cooking taken seriously, with marketing and errands included &mdash; school-age children are fine, and she has asked not to take on eldercare&nbsp;again",
    strengths: ["Contract renewed", "Three cuisines", "Comfortable with dogs"],
    skills: ["Cooking", "Housekeeping", "Pets"],
    age: 30,
    salary: "",
    availability: "transfer",
    photo: "images/lia.jpeg",
    profile: "profile-lia.html"
  },
  {
    id: "rowena",
    name: "Rowena",
    ...
    availFrom: "2026-10-01",
    line: "Filipino &middot; 42 &middot; Childcare, cooking &amp;&nbsp;household",
    summary: "Nearly eleven years with one family &mdash; their child from four years old until he was grown, an elderly family member alongside, the cooking and the&nbsp;house. Eleven of her twelve Singapore years in that one&nbsp;home.",
    referredBy: "",
    signal: "verified",
    verifiedYears: 11,
    verifiedSub: "Ten years and eleven months with one family",
    quote: "",
    quoteCite: "",
    nationality: "Filipino",
    yearsSG: "Since June 2014",
    bestFit: "A family in a flat or condominium with children of any age, who want the child, the cooking and the house in one pair of hands &mdash; and perhaps an elderly parent&nbsp;alongside",
    strengths: ["Eleven years, one family", "A child from four", "Cooks \u2014 photographs"],
    skills: ["Childcare", "Cooking", "Housekeeping", "Elderly Care"],
    age: 42,
    salary: "",
    availability: "transfer",
    photo: "images/rowena.jpeg",
    profile: "profile-rowena.html"
  },
  {
    id: "laylay",
    name: "Lay Lay",
    ...
    status: "available",
    statusLabel: "Available now",
    availFrom: "2026-09-23",
    line: "Myanmar &middot; 42 &middot; Elderly and medical&nbsp;care",
    summary: "Nearly eight years with one family, caring for their grandfather through advanced kidney&nbsp;disease &mdash; daily blood pressure, blood sugar and weight checks, medication, bathing and wheelchair&nbsp;transfers. Two households in ten years, both&nbsp;eldercare.",
    referredBy: "",
    signal: "verified",
    verifiedYears: 8,
    verifiedSub: "Seven years and ten months with one family",
    quote: "&ldquo;Taking care of&nbsp;elderly.&rdquo;",
    quoteCite: "&mdash; Lay Lay, asked what she does for&nbsp;pleasure",
    nationality: "Myanmar",
    ...
    salary: "",
    availability: "transfer",
    photo: "images/laylay.jpeg",
    profile: "profile-laylay.html"
  },
  {
    id: "marselina",
    name: "Marselina",
    initial: "D.",
    status: "available",
    statusLabel: "Available 16 October&nbsp;2026",
    availFrom: "2026-10-16",
    line: "Indonesian &middot; 29 &middot; Eldercare, cooking &amp;&nbsp;household",
    summary: "Four years with one family in a landed house &mdash; the only Singapore employer she has ever&nbsp;had. Their grandmother, their dog, the cooking and the&nbsp;house. She is reading for a law degree online, and asks for every Sunday&nbsp;off.",
    referredBy: "",
    signal: "verified",
    verifiedYears: 4,
    quote: "&ldquo;Grandma is healthy&nbsp;now. But at the market you have to be&nbsp;together &mdash; I am afraid she will&nbsp;fall.&rdquo;",
    ...
    salary: "",
    availability: "transfer",
    photo: "images/marselina.jpeg",
    profile: "profile-marselina.html"
  },
  {
    id: "may",
    name: "May",
    ...
    statusLabel: "Available now",
    availFrom: "2026-09-23",
    line: "Filipino &middot; 46 &middot; Household, cooking &amp;&nbsp;eldercare",
    summary: "Eighteen months caring for two elderly people aged 68 and 79 in a household of five, alongside the cooking and the&nbsp;household &mdash; and four years before that running a three-storey house in&nbsp;Kuwait. Her employer is recommending her as the role&nbsp;ends.",
    referredBy: "Recommended by her current employer, whose elderly parents she has cared for since April&nbsp;2025",
    signal: "referred",
    nationality: "Filipino",
    yearsSG: "Since August 2017",
    bestFit: "A household without young children &mdash; a couple, an older household, or a family with grown children &mdash; who want the house, the cooking and the marketing handled&nbsp;properly",
    strengths: ["Eldercare \u2014 two people", "Four years in Kuwait", "Cooking &amp; marketing"],
    skills: ["Elderly Care", "Cooking", "Housekeeping"],
    age: 46,
    salary: "",
    availability: "transfer",
    photo: "images/may.jpeg",
    profile: "profile-may.html"
  },
  {
    id: "juvy",
    name: "Juvy",
    ...
    statusLabel: "Available 8 October&nbsp;2026",
    availFrom: "2026-10-08",
    line: "Filipino &middot; 46 &middot; Childcare from newborn &amp;&nbsp;cooking",
    summary: "Twelve years with one Singapore family, who recommend her in&nbsp;writing &mdash; she took their second child from newborn until she was&nbsp;ten. That job ended only when the children had grown up and the family no longer needed a&nbsp;helper.",
    referredBy: "Recommended in writing by Elmer&nbsp;C., her employer of twelve&nbsp;years",
    signal: "referred",
    quote: "&ldquo;Juvy has been an invaluable member of our&nbsp;household.&rdquo;",
    quoteCite: "&mdash; Elmer C., her employer for twelve&nbsp;years",
    nationality: "Filipino",
    yearsSG: "Since May 2014",
    bestFit: "A family with a child of any age, from a baby upward, who want the child, the cooking and the household in the same pair of hands &mdash; and who would like someone who&nbsp;stays",
    strengths: ["Twelve years, one family", "A newborn through to ten", "Cooking &amp; household"],
    skills: ["Childcare", "Infant Care", "Cooking", "Housekeeping"],
    age: 46,
    salary: "",
    availability: "transfer",
    photo: "images/juvy.jpeg",
    profile: "profile-juvy.html"
  },
  {
    id: "jennym",
    name: "Jenny M.",
    initial: "",
    status: "available",
    statusLabel: "Available November&nbsp;2026",
    availFrom: "2026-11-01",
    line: "Filipino &middot; 35 &middot; School-age childcare &amp;&nbsp;cooking",
    summary: "Recommended in writing by the family she has been with since December&nbsp;2023 &mdash; nearly three years, across two homes, with their child as her whole&nbsp;job. Available only because they are leaving Singapore for&nbsp;good.",
    referredBy: "Recommended in writing by Aira May M., her employer of nearly three&nbsp;years",
    signal: "referred",
    quote: "&ldquo;I found her to be reliable and dedicated in carrying out her&nbsp;responsibilities. She maintained a positive attitude and was respectful towards all members of the&nbsp;household.&rdquo;",
    quoteCite: "&mdash; Aira May M., her current employer",
    nationality: "Filipino",
    yearsSG: "Since February 2020",
    bestFit: "A family with children of school age, or from about two upward, who want someone whose whole focus is the child &mdash; comfortable with&nbsp;pets",
    strengths: ["Nearly three years, one family", "Children from two upward", "Comfortable with pets"],
    skills: ["Childcare", "Cooking", "Housekeeping", "Pets"],
    age: 35,
    salary: "",
    availability: "transfer",
  ...
  },
  {
    ...
    referredBy: "Recommended in writing by Doug W., her employer since March&nbsp;2025",
    signal: "referred",
    quote: "&ldquo;She is kind and hard working, a great cook and&nbsp;baker. She independently completes her&nbsp;work.&rdquo;",
    quoteCite: "&mdash; Doug W., her current employer",
    nationality: "Filipino",
    yearsSG: "Since September 2010",
    bestFit: "A family with children of any age who want the cooking and the house handled properly, and who would rather not&nbsp;supervise",
    strengths: ["Two newborns from their first weeks", "Travels with the family", "Cook &amp; baker"],
    skills: ["Infant Care", "Childcare", "Cooking", "Housekeeping", "Pets"],
    age: 50,
    salary: "",
    availability: "transfer",
    photo: "images/maryjane.jpeg",
    profile: "profile-maryjane.html"
  },
  {
    id: "richiel",
    name: "Richiel",
    ...
    line: "Filipino &middot; 45 &middot; Newborns, children &amp;&nbsp;cooking",
    summary: "Nine years in Singapore, and a former family who hired her&nbsp;back &mdash; she left them, took another job, and within weeks they asked her to&nbsp;return. Newborns in three of her four households, and Sri Lankan cooking learned over three&nbsp;years.",
    referredBy: "",
    signal: "completed",
    completedSub: "Nine years, four families; one re-employed her",
    nationality: "Filipino",
    yearsSG: "Since September 2017",
    bestFit: "A family with a baby or small children in a flat or condominium who want the cooking handled too &mdash; no dog, and no elderly&nbsp;care",
    strengths: ["Hired back by a former family", "Newborns &amp; toddlers", "Filipino &amp; Sri Lankan cooking"],
    skills: ["Infant Care", "Childcare", "Cooking", "Housekeeping"],
    age: 45,
    salary: "",
    availability: "transfer",
    photo: "images/richiel.jpeg",
    profile: "profile-richiel.html"
  },
  {
    id: "shiji",
    name: "Shiji",
  ...
  },
  {
    ...
    bestFit: "A family with children already at school or close to it, who want the school run, the cooking and the house handled by the same&nbsp;person",
    strengths: ["Two completed contracts", "Children aged five upward", "Likes dogs and cats"],
    skills: ["Childcare", "Cooking", "Housekeeping", "Pets"],
    age: 33,
    salary: "",
    availability: "transfer",
    photo: "images/meriana.jpeg",
    profile: "profile-meriana.html"
  },
  {
    id: "kathy",
    name: "Kathy",
  ...
  },
  {
    ...
    statusLabel: "No longer available",
    availFrom: "2026-09-30",
    line: "Filipino &middot; 37 &middot; Childcare, cooking &amp;&nbsp;household",
    summary: "Four completed contracts across seven Singapore households since 2013 &mdash; two newborns taken from their first weeks, school runs and activities for older ones, and the cooking in every&nbsp;home. She would like a child of two or older&nbsp;next.",
    referredBy: "",
    signal: "completed",
    contracts: 4,
    nationality: "Filipino",
    yearsSG: "Since July 2013",
    bestFit: "A small family in a condominium with one child of two or above, who want the child, the cooking and the house handled by the same&nbsp;person",
  ...
  },
  {
    ...
    initial: "B.",
    status: "available",
    statusLabel: "Available 10 December&nbsp;2026",
    availFrom: "2026-12-10",
    line: "Filipino &middot; 46 &middot; Childcare, Western cooking &amp;&nbsp;household",
    summary: "Five years with one family, who brought her from Hong Kong to Singapore and have recommended her in&nbsp;writing &mdash; two boys, the cooking, and a household she runs without&nbsp;supervision. Available only because they are leaving&nbsp;Singapore.",
    referredBy: "Referred by Emma L., her employer of five years, happy to speak with interested&nbsp;families",
    signal: "referred",
    quote: "\u201cWe have found Beverly to be trustworthy, dependable, hardworking and&nbsp;caring.\u201d",
    quoteCite: "&mdash; Emma L., her employer",
    nationality: "Filipino",
    yearsSG: "Since April 2022",
    bestFit: "A family with children who want the house taken off their hands as&nbsp;well",
    strengths: ["Five years, one family", "Trusted with the boys alone", "Runs a home unsupervised"],
    skills: ["Childcare", "Cooking", "Housekeeping", "Elderly Care"],
    age: 46,
    salary: "S$1,000&ndash;1,100",
    availability: "transfer",
    photo: "images/beverly.jpeg",
    profile: "profile-beverly.html"
  },
  {
    id: "grace",
    name: "Grace",
    ...
    status: "placed",
    matchedSeq: 21,
    statusLabel: "Joined a new family &middot; 9 Oct&nbsp;2026",
    availFrom: "2026-10-14",
    line: "Filipino &middot; 51 &middot; Newborn care, childcare &amp;&nbsp;household",
    summary: "Seventeen years in Singapore, ten and a half of them with one family &mdash; and written references from three of the families she has worked&nbsp;for. Newborn care through to teenagers is what she does, and what she&nbsp;wants &mdash; there is a baby in her household&nbsp;now.",
    referredBy: "Referred by Florilynn, her employer of eleven years, and two further families in&nbsp;writing",
    signal: "referred",
    quote: "\u201cShe has been a caring auntie to our kids &mdash; the kids still talk to her up to now, as she is considered part of the&nbsp;family.\u201d",
    quoteCite: "&mdash; Florilynn, her employer of eleven years",
    nationality: "Filipino",
    yearsSG: "Since September 2009",
    bestFit: "A family with children who want someone who has done this for seventeen years and would like to&nbsp;stay",
    strengths: ["Ten and a half years, one family", "Three written references", "Newborn care upwards"],
    skills: ["Childcare", "Infant Care", "Cooking", "Housekeeping"],
    age: 51,
    salary: "S$900",
    availability: "transfer",
    photo: "images/grace.jpeg",
    profile: "profile-grace.html"
  },
  {
    id: "julie",
    name: "Julie",
    ...
    referredBy: "Referred by Sheila, her employer since December 2024, who asked her more than once to&nbsp;stay",
    signal: "referred",
    quote: "\u201cOne of the qualities we value most about Julie is her honesty. We have been able to trust her, particularly when it comes to caring for our&nbsp;children.\u201d",
    ...
    salary: "S$850",
    availability: "transfer",
    photo: "images/julie.jpeg",
    profile: "profile-julie.html"
  },
  {
    id: "belinda",
    name: "Belinda",
  ...
  },
  {
    ...
    summary: "Sixteen years in Singapore, almost all of it elderly and medical&nbsp;care &mdash; five years with one family, and two further stays of over three&nbsp;years. Stroke, dementia, diabetes and bedridden care, in English and&nbsp;Malay.",
    referredBy: "",
    signal: "verified",
    verifiedSub: "Five years with one family, sixteen in Singapore",
    quote: "",
    quoteCite: "",
    nationality: "Indonesian",
    yearsSG: "Since September 2010",
    bestFit: "Elderly &amp; medical&nbsp;care",
    strengths: ["Elderly &amp; medical care", "Five years, one family", "English &amp; Malay"],
