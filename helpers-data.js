...
window.HELPERS = [
  ...
  },
  {
    ...
    summary: "Ten years with one Singapore family of four children, supported by employment records we reviewed &mdash; she took the youngest from newborn to ten, and helped with the older three, the cooking and the household&nbsp;besides.",
    referredBy: "",
    signal: "verified",
    verifiedYears: 10,
    nationality: "Filipino",
